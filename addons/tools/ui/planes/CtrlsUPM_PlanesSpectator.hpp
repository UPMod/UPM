class PlanesSpectator: RscControlsGroup
{
	idc = D_C_CPLANESSPECTATOR;
	text = "";
	...
	class controls
	{
		...
		class PlanesList: RscControlsGroup
		{
			idc = 7912;
			text = "";
			x = 0;
			...
			class controls
			{
				...
				class BluforTab: RscButton
				{
    				...
    				style = ST_CENTER;
    				font = "puristaMedium";
					action = QUOTE(GVAR(selectedList) = 'BLUFOR'; [] call FUNC(debugPlanesSelectList));
				};
				class OpforTab: RscButton
				{
    				...
    				style = ST_CENTER;
    				font = "puristaMedium";
    				action = QUOTE(GVAR(selectedList) = 'OPFOR'; [] call FUNC(debugPlanesSelectList));
				};
				class IndependentsTab: RscButton
				{
    				...
    				style = ST_CENTER;
    				font = "puristaMedium";
    				action = QUOTE(GVAR(selectedList) = 'INDEPENDENTS'; [] call FUNC(debugPlanesSelectList));
				};
				class CivilianTab: RscButton
				{
    				...
    				style = ST_CENTER;
    				font = "puristaMedium";
    				action = QUOTE(GVAR(selectedList) = 'CIVILIANS'; [] call FUNC(debugPlanesSelectList));
				};
				class PlayersTab: RscButton
				{
    				...
    				style = ST_CENTER;
    				font = "puristaMedium";
    				action = QUOTE(GVAR(selectedList) = 'PLAYERS'; [] call FUNC(debugPlanesSelectList));
				};
			};
		};
		class PlanesMap: RscControlsGroup
		{
			idc = 79130;
			text = "";
			x = 0.2945 * safezoneW;
			...
			class controls
			{
				...
				class ButtonFreeCam: RscButtonUPM_Tools
				{
					...
					action = QUOTE(GVAR(planeSpectatorPrespective) = 'FREECAM'; [] call FUNC(debugPlanesSpectatorHandle));
				};
				class ButtonThirdPerson: RscButtonUPM_Tools
				{
					...
					colorBackground2[] = {0.6,0.6,0.6,0.55};
					colorBackgroundFocused[] = {0.6,0.6,0.6,1};
					action = QUOTE(GVAR(planeSpectatorPrespective) = 'THIRDPERSON'; [] call FUNC(debugPlanesSpectatorHandle));
				};
				class ButtonFirstPerson: RscButtonUPM_Tools
				{
					...
					colorBackground2[] = {0.6,0.6,0.6,0.55};
					colorBackgroundFocused[] = {0.6,0.6,0.6,1};
					action = QUOTE(GVAR(planeSpectatorPrespective) = 'FIRSTPERSON'; [] call FUNC(debugPlanesSpectatorHandle));
				};
			};
		};
	};
