class StaticsSpectator: RscControlsGroup
{
	idc = D_C_CSTATICSSPECTATOR;
	text = "";
	...
	class controls
	{
		...
		class StaticsList: RscControlsGroup
		{
			idc = 7912;
			text = "";
			x = 0;
			...
			class controls
			{
				...
				class BluforTab: RscButton
				{
    				...
    				style = ST_CENTER;
    				font = "puristaMedium";
					action = QUOTE(GVAR(selectedList) = 'BLUFOR'; [] call FUNC(debugStaticsSelectList));
				};
				class OpforTab: RscButton
				{
    				...
    				style = ST_CENTER;
    				font = "puristaMedium";
    				action = QUOTE(GVAR(selectedList) = 'OPFOR'; [] call FUNC(debugStaticsSelectList));
				};
				class IndependentsTab: RscButton
				{
    				...
    				style = ST_CENTER;
    				font = "puristaMedium";
    				action = QUOTE(GVAR(selectedList) = 'INDEPENDENTS'; [] call FUNC(debugStaticsSelectList));
				};
				class CivilianTab: RscButton
				{
    				...
    				style = ST_CENTER;
    				font = "puristaMedium";
    				action = QUOTE(GVAR(selectedList) = 'CIVILIANS'; [] call FUNC(debugStaticsSelectList));
				};
				class PlayersTab: RscButton
				{
    				...
    				style = ST_CENTER;
    				font = "puristaMedium";
    				action = QUOTE(GVAR(selectedList) = 'PLAYERS'; [] call FUNC(debugStaticsSelectList));
				};
			};
		};
		class StaticsMap: RscControlsGroup
		{
			idc = 79130;
			text = "";
			x = 0.2945 * safezoneW;
			...
			class controls
			{
				...
				class ButtonFreeCam: RscButtonUPM_Tools
				{
					...
					action = QUOTE(GVAR(staticSpectatorPrespective) = 'FREECAM'; [] call FUNC(debugStaticsSpectatorHandle));
				};
				class ButtonThirdPerson: RscButtonUPM_Tools
				{
					...
					colorBackground2[] = {0.6,0.6,0.6,0.55};
					colorBackgroundFocused[] = {0.6,0.6,0.6,1};
					action = QUOTE(GVAR(staticSpectatorPrespective) = 'THIRDPERSON'; [] call FUNC(debugStaticsSpectatorHandle));
				};
				class ButtonFirstPerson: RscButtonUPM_Tools
				{
					...
					colorBackground2[] = {0.6,0.6,0.6,0.55};
					colorBackgroundFocused[] = {0.6,0.6,0.6,1};
					action = QUOTE(GVAR(staticSpectatorPrespective) = 'FIRSTPERSON'; [] call FUNC(debugStaticsSpectatorHandle));
				};
			};
		};
	};
