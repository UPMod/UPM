class HelisSpectator: RscControlsGroup
{
	idc = D_C_CHelisSPECTATOR;
	text = "";
	...
	class controls
	{
		...
		class HelisList: RscControlsGroup
		{
			idc = 7912;
			text = "";
			x = 0;
			...
			class controls
			{
				...
				class BluforTab: RscButton
				{
    				...
    				style = ST_CENTER;
    				font = "puristaMedium";
					action = QUOTE(GVAR(selectedList) = 'BLUFOR'; [] call FUNC(debugHelisSelectList));
				};
				class OpforTab: RscButton
				{
    				...
    				style = ST_CENTER;
    				font = "puristaMedium";
    				action = QUOTE(GVAR(selectedList) = 'OPFOR'; [] call FUNC(debugHelisSelectList));
				};
				class IndependentsTab: RscButton
				{
    				...
    				style = ST_CENTER;
    				font = "puristaMedium";
    				action = QUOTE(GVAR(selectedList) = 'INDEPENDENTS'; [] call FUNC(debugHelisSelectList));
				};
				class CivilianTab: RscButton
				{
    				...
    				style = ST_CENTER;
    				font = "puristaMedium";
    				action = QUOTE(GVAR(selectedList) = 'CIVILIANS'; [] call FUNC(debugHelisSelectList));
				};
				class PlayersTab: RscButton
				{
    				...
    				style = ST_CENTER;
    				font = "puristaMedium";
    				action = QUOTE(GVAR(selectedList) = 'PLAYERS'; [] call FUNC(debugHelisSelectList));
				};
			};
		};
		class HelisMap: RscControlsGroup
		{
			idc = 79130;
			text = "";
			x = 0.2945 * safezoneW;
			...
			class controls
			{
				...
				class ButtonFreeCam: RscButtonUPM_Tools
				{
					...
					action = QUOTE(GVAR(heliSpectatorPrespective) = 'FREECAM'; [] call FUNC(debugHelisSpectatorHandle));
				};
				class ButtonThirdPerson: RscButtonUPM_Tools
				{
					...
					colorBackground2[] = {0.6,0.6,0.6,0.55};
					colorBackgroundFocused[] = {0.6,0.6,0.6,1};
					action = QUOTE(GVAR(heliSpectatorPrespective) = 'THIRDPERSON'; [] call FUNC(debugHelisSpectatorHandle));
				};
				class ButtonFirstPerson: RscButtonUPM_Tools
				{
					...
					colorBackground2[] = {0.6,0.6,0.6,0.55};
					colorBackgroundFocused[] = {0.6,0.6,0.6,1};
					action = QUOTE(GVAR(heliSpectatorPrespective) = 'FIRSTPERSON'; [] call FUNC(debugHelisSpectatorHandle));
				};
			};
		};
	};
