class NavalSpectator: RscControlsGroup
{
	idc = D_C_CNAVALSPECTATOR;
	text = "";
	...
	class controls
	{
		...
		class NavalList: RscControlsGroup
		{
			idc = 7912;
			text = "";
			x = 0;
			...
			class controls
			{
				...
				class BluforTab: RscButton
				{
    				...
    				style = ST_CENTER;
    				font = "puristaMedium";
					action = QUOTE(GVAR(selectedList) = 'BLUFOR'; [] call FUNC(debugNavalSelectList));
				};
				class OpforTab: RscButton
				{
    				...
    				style = ST_CENTER;
    				font = "puristaMedium";
    				action = QUOTE(GVAR(selectedList) = 'OPFOR'; [] call FUNC(debugNavalSelectList));
				};
				class IndependentsTab: RscButton
				{
    				...
    				style = ST_CENTER;
    				font = "puristaMedium";
    				action = QUOTE(GVAR(selectedList) = 'INDEPENDENTS'; [] call FUNC(debugNavalSelectList));
				};
				class CivilianTab: RscButton
				{
    				...
    				style = ST_CENTER;
    				font = "puristaMedium";
    				action = QUOTE(GVAR(selectedList) = 'CIVILIANS'; [] call FUNC(debugNavalSelectList));
				};
				class PlayersTab: RscButton
				{
    				...
    				style = ST_CENTER;
    				font = "puristaMedium";
    				action = QUOTE(GVAR(selectedList) = 'PLAYERS'; [] call FUNC(debugNavalSelectList));
				};
			};
		};
		class NavalMap: RscControlsGroup
		{
			idc = 79130;
			text = "";
			x = 0.2945 * safezoneW;
			...
			class controls
			{
				...
				class ButtonFreeCam: RscButtonUPM_Tools
				{
					...
					action = QUOTE(GVAR(navalSpectatorPrespective) = 'FREECAM'; [] call FUNC(debugNavalSpectatorHandle));
				};
				class ButtonThirdPerson: RscButtonUPM_Tools
				{
					...
					colorBackground2[] = {0.6,0.6,0.6,0.55};
					colorBackgroundFocused[] = {0.6,0.6,0.6,1};
					action = QUOTE(GVAR(navalSpectatorPrespective) = 'THIRDPERSON'; [] call FUNC(debugNavalSpectatorHandle));
				};
				class ButtonFirstPerson: RscButtonUPM_Tools
				{
					...
					colorBackground2[] = {0.6,0.6,0.6,0.55};
					colorBackgroundFocused[] = {0.6,0.6,0.6,1};
					action = QUOTE(GVAR(navalSpectatorPrespective) = 'FIRSTPERSON'; [] call FUNC(debugNavalSpectatorHandle));
				};
			};
		};
	};
