class PerformanceWindow: RscControlsGroup
{
	idc = D_C_WPERFORMANCE;
	text = "";
	...
	class controls
	{
		...
		class PerformanceBackground: RscBackgroundUPM_Window
		{
			idc = -1;
			x = 0;
			y = 0.035 * safezoneH;
		...
		// MENU
		#include <CtrlsUPM_PerformanceMenu.hpp>
		// CONTENT
		#include <CtrlsUPM_PerformanceGeneral.hpp>
	};
};