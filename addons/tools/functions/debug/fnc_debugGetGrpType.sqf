...
private [
	"_unit","_vehicle"
	"_type","_vehicle_checked","_infos","_vehicle","_iscargo","_armor","_canon","_mg_gun","_missiles","_parents","_weapon","_mun"
];
...
if (!(_infos isEqualTo [])) then {_infos sort DESC; _type = (_infos select 0) select 1;};
